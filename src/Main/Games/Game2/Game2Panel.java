...
public class Game2Panel extends GamePanel implements ActionListener, KeyListener { //O GameColeta herda o Game1Panel (que é o menu principal)
...
//Toda essa parte serve para controlat o tamanho largura das lixeiras, velocidade em que os lixinhos caem
    ...
    private void loadImages() {
        imgPapel = new ImageIcon("src/Main/Games/Game2/Assets/Lixo_Papel.png").getImage(); //Add todas as imagens
        imgPlastico = new ImageIcon("src/Main/Games/Game2/Assets/Lixo_Plastico.png").getImage();
        imgLata = new ImageIcon("src/Main/Games/Game2/Assets/Lixo_Lata.png").getImage();
        binImgAzul = new ImageIcon("src/Main/Games/Game2/Assets/Lixeira_azul.png").getImage();
        binImgVermelha = new ImageIcon("src/Main/Games/Game2/Assets/Lixeira_Vermelha.png").getImage();
        binImgVerde = new ImageIcon("src/Main/Games/Game2/Assets/Lixeira_Verde.png").getImage();
        backgroundImage = new ImageIcon("src/Main/Games/Game2/Assets/Fundo_Coleta.jpg").getImage();
    }
