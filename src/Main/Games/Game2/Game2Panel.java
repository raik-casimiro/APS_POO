...
public class Game2Panel extends GamePanel {
    ...
    public Game2Panel(JFrame frame) {
        ...
        bgPanel = new BackgroundPanel(new ImageIcon("src/Main/Games/Game2/Assets/fundo.png").getImage());
    ...
    private void loadImages() {
        for (int i = 0; i < NUM_PAIRS; i++) {
            cardIcons[i] = new ImageIcon("src/Main/Games/Game2/Assets/card" + i + ".png");
        }
        cardBack = new ImageIcon("src/Main/Games/Game2/Assets/bg.png");
    }
